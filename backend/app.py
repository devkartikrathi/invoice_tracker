...
def get_db():
    if 'mongo_client' not in g:
        ...
        g.db = g.mongo_client[DATABASE_NAME]
    return g.db
...
def delete_invoice(invoice_id):
    get_db().invoices.delete_one({"_id": ObjectId(invoice_id)})
